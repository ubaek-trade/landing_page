...
3. 배포 후 `https://cheongangtrade.com/googleXXXXXXXXX.html` 접속 확인
...
1. 상단 검색창에 `https://cheongangtrade.com` 입력
2. **"색인 생성 요청"** 클릭
3. 1-2분 대기 후 완료
...
2. 다운로드한 파일을 프로젝트의 `public/` 폴더에 복사
3. 배포 후 `https://cheongangtrade.com/naver-site-verification.html` 접속 확인
4. 서치어드바이저에서 **"소유확인"** 클릭
...
2. `https://cheongangtrade.com/sitemap.xml` 입력
3. **"확인"** 클릭

### Step 5: 수집 요청
1. 좌측 메뉴 **"요청" > "URL 수집 요청"** 클릭
2. `https://cheongangtrade.com` 입력
3. **"확인"** 클릭
...
### 1. 색인 확인 방법
- **구글**: `site:cheongangtrade.com` 구글 검색
- **네이버**: `site:cheongangtrade.com` 네이버 검색
...
### 확인
- [ ] 1주일 후 `site:cheongangtrade.com` 검색 확인
